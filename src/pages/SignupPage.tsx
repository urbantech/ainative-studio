...
export default function SignupPage() {
  const handleGitHubLogin = () => {
    const clientId = "Ov23liU7x20VoRInkAiq"; // GitHub OAuth Client ID
    const redirectUri = "http://localhost:3000/login-success"; // Your frontend callback page
      ...
      <Card className="w-full max-w-md shadow-xl border border-white/10 dark:bg-[#1C2128] rounded-2xl">
        <CardHeader className="space-y-3 text-center">
          <div className="flex justify-center mb-1">
            <UserPlus className="h-8 w-8 text-[#4B6FED]" />
          </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="name" type="text" placeholder="John Doe" className="bg-[#0D1117] border-white/10 text-white placeholder-gray-500" />
            </div>
            <div className="space-y-2">
        ...
        <CardFooter className="flex flex-col space-y-5 pt-6">
          ...
          <p className="text-sm text-center text-gray-400">
            ...
            <Link to="/login" className="text-[#4B6FED] hover:underline">
              Sign in
            </Link>
          </p>
        </CardFooter>
